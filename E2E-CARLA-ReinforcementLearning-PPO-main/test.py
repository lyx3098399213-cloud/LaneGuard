...
def game_loop(args):
    ...
    try:
        ...
        try:
            ...
            print("[WARN] world reset failed:", e)

        # ✅ Safe model load
        model_path = f"C:/Users/LiuYuXiang/Desktop/E2E-CARLA-ReinforcementLearning-PPO-main/logs/1758001643/best_model"
        try:
            model = RecurrentPPO.load(model_path, env=world, print_system_info=False)
